const endpointCountries = "https://apiv3.apifootball.com/?action=get_countries&APIkey=76929220140bb4484e845361f18b088ef603219096dbf4efcd2e322932f9eaf2";
...
fetch(endpointCountries)
    ...
    const endpointPlayers = "https://apiv3.apifootball.com/?action=get_players&player_name=Benzema&team_name=Spain&APIkey=76929220140bb4484e845361f18b088ef603219096dbf4efcd2e322932f9eaf2";
    ...
    fetch(endpointPlayers)
        ...
        .then(data => {
            ...
            data.forEach(player => {
                ...
                const attributesToShow = ['player_name', 'player_age', 'player_type', 'player_goals', 'player_assists', 'team_name'];
        ...
        const endpointTeams = "https://apiv3.apifootball.com/?action=get_teams&league_id=302&APIkey=76929220140bb4484e845361f18b088ef603219096dbf4efcd2e322932f9eaf2";
        ...
        function displayPlayers(teamKey) {
            const endpointPlayers = `https://apiv3.apifootball.com/?action=get_players&team_id=${teamKey}&APIkey=76929220140bb4484e845361f18b088ef603219096dbf4efcd2e322932f9eaf2`;
